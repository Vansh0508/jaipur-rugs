...
export function LoginForm() {
  ...
  async function handleSubmit(event: React.FormEvent) {
    ...
    // proxy.ts re-verifies active status and onboarding completion server-side on the
    // very next request this navigation triggers, and routes to /onboarding or /profile
    // accordingly — no client-side branching duplicated here.
    router.push("/profile");
    router.refresh();
  }
