...
//
// FacetCheckboxList/SingleSelect moved to components/FilterPrimitives.tsx, 2026-09-10,
// so RugLensFilterPanel can reuse the exact same controls — see that file's comment for
// the original design rationale (checkboxes over a native multi-select, etc.).
