...
// db/feedback/005_create_driver_photos_bucket.sql). This is a deliberate override of
// AGENTS.md's default "self-hosted S3" object storage choice, recorded in AGENTS.md
// Section 1 — do not treat this as the general pattern for other modules without the
// same explicit call.
